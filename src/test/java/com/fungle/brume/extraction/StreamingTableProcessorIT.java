...
class StreamingTableProcessorIT {

    @MockitoBean
    private ReplicationAgent replicationAgent;

    @Autowired
    private StreamingTableProcessor streamingTableProcessor;
    ...
    @Test
    @DisplayName("Le processeur streaming produit le même dataset cohérent que le pipeline batch attendu")
    void shouldProcessConfiguredTablesInStreamingMode() {
        ...
        streamingTableProcessor.processAll(config, schema, report);
